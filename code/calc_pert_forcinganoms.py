...
grid_dir= '/users/emmomp/data/orchestra/grid2/'
exf_vars=['EXFqnet','EXFempmr','EXFtaux','EXFtauy','oceTAUX','oceTAUY','oceFWflx','oceQnet']
        ...
        if os.path.isfile(fout):
            ...
            if ds_all:
                if 'EXFtaux' in ds_all:
                    ...
                    [ds_all['EXFtauu'],ds_all['EXFtauv']]=ecco.vector_calc.UEVNfromUXVY(ds_all['EXFtaux'],ds_all['EXFtauy'],ecco_grid)
                    ds_all.drop_vars(['EXFtaux','EXFtauy'])
                
                if 'oceTAUX' in ds_all:
                    ds_all['oceTAUX']=ds_all['oceTAUX'].load()
                    ds_all['oceTAUY']=ds_all['oceTAUY'].load()
                    [ds_all['oceTAUU'],ds_all['oceTAUV']]=ecco.vector_calc.UEVNfromUXVY(ds_all['oceTAUX'],ds_all['oceTAUY'],ecco_grid)
                    ds_all.drop_vars(['oceTAUX','oceTAUY'])
                    
                if 'oceFWflx' in ds_all:
                    ds_all['oceFWflx']=-ds_all['oceFWflx']/rhoconst # Convert to m/s, same sign as EMPMR
