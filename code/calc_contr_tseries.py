...
for eyear in eyears:
   ...
   #     else:
        ...
        dJpred_ecco_cumsum["wind_EXF"] = (
            dJpred_ecco_cumsum["adxx_tauuXEXFtauu"]
            + dJpred_ecco_cumsum["adxx_tauvXEXFtauv"]
        )
        ...
        dJpred_ecco_cumsum["all_OCE"] = (
            dJpred_ecco_cumsum[ecco_convs_2d['OCE']].to_array().sum("variable")
        )
        dJpred_ecco_cumsum["all_EXF"] = (
            dJpred_ecco_cumsum[ecco_convs_2d['EXF']].to_array().sum("variable")
        )
